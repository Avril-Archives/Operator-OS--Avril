...
// DefaultConfig returns the default configuration for Operator.
func DefaultConfig() *Config {
	// Determine the base path for the workspace.
	// Priority: $OPERATOR_HOME > ~/.operator
	var homePath string
	if operatorHome := os.Getenv("OPERATOR_HOME"); operatorHome != "" {
		homePath = operatorHome
	} else {
		userHome, _ := os.UserHomeDir()
		homePath = filepath.Join(userHome, ".operator")
	}
