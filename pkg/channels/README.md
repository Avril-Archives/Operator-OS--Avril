# Operator Channel System: Complete Development Guide

> **Scope**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/operator/internal/gateway/`
...
4. **Pico Protocol**: `pkg/channels/pico/` implements a custom Operator native protocol channel that receives messages via WebSocket webhook (`/pico/ws`).
